...
import { AuthenticationService, MgApplicationUser } from '../../core/services/auth.service';
...
export class TopbarComponent implements OnInit {
  ...
  constructor(@Inject(DOCUMENT) private document: Document, private router: Router, private authService: AuthenticationService,
